...
export default function NewStoryPrompt() {
    ...
    useEffect(() => {
        const fetchCredits = async () => {
            try {
                const response = await fetch(`http://192.168.221.244:3001/get-credits?username=${username}`);
                const data = await response.json();
    ...
    const handleSubmit = async () => {
        ...
        try {
            const response = await fetch('http://192.168.221.244:3000/generate-story', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
    ...
    const deductCredits = async () => {
        try {
            const response = await fetch("http://192.168.221.244:3001/deduct-credits", {
                method: "POST",
                headers: { "Content-Type": "application/json" },
    ...
    const sendStoryToBackend = async (storyText, audioUrl) => {
        try {
            const response = await fetch('http://192.168.221.244:3001/story', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
